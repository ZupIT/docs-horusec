...
- [**Web application**]({{< ref path="/web/overview.md">}}) is the CLI extensions used to manage and classify the vulnerabilities found in your application. 
...
**CLI**
- [**Horusec-CLI**]({{< ref path="/cli/installation.md">}})

**Web application**
- [**Install with Docker-Compose**]({{< ref path="/web/installation/install-with-docker-compose.md">}})
- [**Install with Helm**]({{< ref path="/web/installation/install-with-helm.md">}})
- [**Install with Operator**]({{< ref path="/web/installation/install-with-operator/overview.md">}})
